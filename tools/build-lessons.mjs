...
const lessons = [
  ...
  },
  {
    ...
    exampleTiles: ["1m","2m","3m","3m","4m","5m","6p","7p","2s","4s","5z","5z","9p","1s"],
    exampleLabel: "综合色训练手牌",
    exampleHtml: `<p><strong>第一扫：</strong>识别一二三万完成面子、三四五万完成面子、六七筒两面、二四索嵌张、白牌对子；牌块已经超过五个。</p>
      ${rack(["6p","7p"],"六七筒两面")}
      ${rack(["2s","4s"],"二四索嵌张")}
      <p><strong>第二扫：</strong>两面八枚、嵌张四枚；若实际可见牌不反转，优先让更弱块退出。</p>
      <p><strong>第三扫：</strong>检查孤立牌是否只是多余牌，以及拆块后最终听牌质量。</p>
