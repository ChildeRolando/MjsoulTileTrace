...
const lessons = [
  ...
  {
    slug: "0013-one-shanten-families",
    id: "lesson-0013",
    title: "一向听不是一种形状",
    objective: "把一向听分成标准形、无雀头形与黏着形，先认状态家族再比较舍牌。",
    principle: "相同向听数可以拥有完全不同的有效牌来源。",
    concepts: [
      ["标准一向听","两个完成面子、两个搭子、一个对子和一张浮牌；有效牌主要来自完成两个搭子。"],
      ["无雀头与黏着","无雀头形由两个搭子争夺面子与雀头；黏着形靠两张浮牌连接出最后一个搭子。"]
    ],
    exampleTitle: "三种一向听，三种思考方式",
    exampleTiles: ["1m","2m","3m","4m","5m","6m","2p","3p","6s","7s","5z","5z","9p"],
    exampleLabel: "标准一向听：两个面子、两个搭子、对子和浮牌",
    exampleHtml: `<p><strong>标准形：</strong>完成任一搭子即可进入听牌；浮牌主要承担改良。</p>
      ${rack(["1m","2m","3m","4m","5m","6m","7p","8p","9p","2s","3s","6s","7s"],"无雀头一向听：三个面子和两个搭子")}
      <p><strong>无雀头形：</strong>没有固定对子，搭子中的牌既可能完成顺子，也可能成对成为雀头。</p>
      ${rack(["1m","2m","3m","4m","5m","6m","7p","8p","9p","5z","5z","3s","7s"],"黏着一向听：三个面子、对子和两张浮牌")}
      <p><strong>黏着形：</strong>最后一个搭子尚未形成，两张浮牌周围的大量邻牌都可能让手牌进入听牌。</p>`,
    quizzes: [
      {
        prompt: "两个面子、两个搭子、一个对子和一张浮牌属于哪一类？",
        choices: [
          ["属于标准一向听形",true,"五个结构槽已经明确，主要任务是完成两个搭子之一。"],
          ["属于无雀头一向听",false,"题目已经明确存在一个对子。"],
          ["属于黏着一向听形",false,"题目已经有两个搭子，不需要从浮牌制造最后搭子。"]
        ]
      },
      {
        prompt: "三个完成面子加两个搭子、却没有对子，属于哪一类？",
        choices: [
          ["属于无雀头一向听",true,"两个搭子要同时承担最后面子与雀头来源。"],
          ["属于标准一向听形",false,"标准形已经保有固定雀头。"],
          ["属于已经完成和牌形",false,"没有雀头，尚未完成普通和牌。"]
        ]
      },
      {
        prompt: "三个完成面子、一个对子和两张浮牌，核心任务是什么？",
        choices: [
          ["让浮牌黏出最后搭子",true,"只要制造一个搭子，就能进入听牌。"],
          ["重新拆掉三个完成面子",false,"这通常会增加向听。"],
          ["把对子改成两张浮牌",false,"现有对子正好承担雀头。"]
        ]
      }
    ],
    retrieval: "看到一向听先分类：有几个面子、搭子、对子和真正浮牌？",
    source: commonSource
  },
  {
    slug: "0014-standard-one-shanten",
    id: "lesson-0014",
    title: "标准一向听：两搭子竞速",
    objective: "在最常见的一向听结构中，准确计算两个搭子的有效牌并处理浮牌改良。",
    principle: "标准一向听的主进张，是完成两个现成搭子的有效牌并集。",
    concepts: [
      ["直接层","两个搭子的完成牌全部是降向听牌；共享牌种去重，再扣已知牌。"],
      ["改良层","浮牌及搭子周围的摸牌可能把愚形换成两面，但只有直接层接近时才破平。"]
    ],
    exampleTitle: "四种有效牌，共十六枚",
    exampleTiles: ["1m","2m","3m","4m","5m","6m","2p","3p","9p","6s","7s","5z","5z"],
    exampleLabel: "两个完成面子、二三筒与六七索两个两面、白牌对子和九筒浮牌",
    exampleHtml: `${rack(["1p","4p","5s","8s"],"标准一向听的四种有效牌",{0:"effective",1:"effective",2:"effective",3:"effective"})}
      <div class="calculation">一筒、四筒、五索、八索各四枚 ＝ 十六枚</div>
      <p>摸入其中任一张，都会完成一个搭子并进入听牌。九筒的邻牌可能改善未来形状，但不应和这十六枚直接有效牌混算。</p>`,
    quizzes: [
      {
        prompt: `${rack(["2m","3m","6p","7p"],"二三万与六七筒两个两面")}相关牌全活时，标准一向听共有多少直接进张？`,
        choices: [
          ["四种合计十六枚牌",true,"两个两面各接受两端，共四种十六枚。"],
          ["两种合计八枚进张",false,"只计算了其中一个两面。"],
          ["六种合计二十四枚",false,"把并不存在的完成牌加入了集合。"]
        ]
      },
      {
        prompt: "两个搭子的有效牌都包含同一张牌时，应怎样合并？",
        choices: [
          ["并集去重后计算一次",true,"同一实体牌不能因两种解释重复出现。"],
          ["每个搭子分别算四枚",false,"这会把最多四张虚增为八张。"],
          ["把共享牌完全删除掉",false,"共享牌仍有效，只是不重复相加。"]
        ]
      },
      {
        prompt: "标准一向听中浮牌的改良何时进入比较？",
        choices: [
          ["直接进张接近时再看",true,"它属于二次改良层。"],
          ["必须放在向听数之前",false,"任何浮牌潜力都不能越过向听优先。"],
          ["应当永远完全忽略掉",false,"同层破平时改良很有价值。"]
        ]
      }
    ],
    retrieval: "标准一向听先把两个搭子的完成牌取并集。",
    source: commonSource
  },
  {
    slug: "0015-headless-one-shanten",
    id: "lesson-0015",
    title: "无雀头一向听：搭子也能生雀头",
    objective: "理解没有固定对子时，搭子自身牌张成对也会降低向听。",
    principle: "无雀头形的有效牌不只包含完成搭子的牌，还包含把搭子牌变成对子。",
    concepts: [
      ["完成面子","摸到搭子外侧或中间牌，可完成最后一个面子，剩余搭子拆成单骑候选。"],
      ["生成雀头","摸到搭子中已有的牌，可形成对子；另一搭子继续承担最后面子。"]
    ],
    exampleTitle: "两个两面产生八种有效牌",
    exampleTiles: ["1m","2m","3m","4m","5m","6m","7p","8p","9p","2s","3s","6s","7s"],
    exampleLabel: "三个面子加二三索与六七索两个两面，没有对子",
    exampleHtml: `${rack(["1s","2s","3s","4s","5s","6s","7s","8s"],"无雀头一向听的八种有效牌",{0:"effective",1:"effective",2:"effective",3:"effective",4:"effective",5:"effective",6:"effective",7:"effective"})}
      <div class="calculation">外侧完成牌各四枚；搭子自身牌各剩三枚；合计二十八枚</div>
      <p>例如摸二索形成对子，六七索仍是最后搭子；摸一索完成一二三索，六七索可拆一张留下单骑方向。不要只按两个两面各八枚计算。</p>`,
    quizzes: [
      {
        prompt: `${rack(["2p","3p","6p","7p"],"二三筒与六七筒两个搭子且没有雀头")}摸到二筒为何能降低向听？`,
        choices: [
          ["二筒对子可成为雀头",true,"另一搭子继续承担最后面子。"],
          ["二筒立即组成了顺子",false,"两张二筒只是对子，不是顺子。"],
          ["二筒自动变成了刻子",false,"摸后只有两张二筒。"]
        ]
      },
      {
        prompt: "无雀头形为什么常比表面两个两面十六枚更宽？",
        choices: [
          ["搭子自身成对也有效",true,"四种搭子牌自身都可能生成雀头。"],
          ["所有字牌都会自动有效",false,"无关字牌不会因此降向听。"],
          ["已知牌无需从四张扣除",false,"已知牌仍必须正常扣除。"]
        ]
      },
      {
        prompt: "摸牌完成其中一个搭子后，另一个搭子常怎样处理？",
        choices: [
          ["拆一张形成单骑方向",true,"四个面子已齐，需要从剩余两张中保留雀头候选。"],
          ["固定保留成第五个面子",false,"普通和牌只需要四个面子。"],
          ["两张都必须立刻公开",false,"是否公开与牌效率结构无关。"]
        ]
      }
    ],
    retrieval: "无雀头形列有效牌时，别忘了搭子牌自身的对子进张。",
    source: commonSource
  },
  {
    slug: "0016-kuttsuki-one-shanten",
    id: "lesson-0016",
    title: "黏着一向听：浮牌就是进张发动机",
    objective: "在三个面子与固定雀头之后，用两张浮牌周围的连接范围制造最后搭子。",
    principle: "黏着形需要的不是完成搭子，而是先形成任意可用搭子。",
    concepts: [
      ["黏着范围","一张中张与距离一或二的邻牌连接，就能形成两面或嵌张，使手牌进入听牌。"],
      ["浮牌干涉","两张浮牌过近时连接范围会重叠；过远时范围更独立，但最终形质量仍不同。"]
    ],
    exampleTitle: "两张中张带来极宽进张",
    exampleTiles: ["1m","2m","3m","4m","5m","6m","7p","8p","9p","3s","7s","5z","5z"],
    exampleLabel: "三个完成面子、白牌对子、三索与七索两张浮牌",
    exampleHtml: `${rack(["1s","2s","3s","4s","5s","6s","7s","8s","9s","5z"],"黏着一向听的有效牌范围",{0:"effective",1:"effective",2:"effective",3:"effective",4:"effective",5:"effective",6:"effective",7:"effective",8:"effective",9:"effective"})}
      <p>三索可与一、二、四、五索连接；七索可与五、六、八、九索连接。摸三索或七索可先形成对子，摸白则把对子变刻子并转为无雀头听牌方向。</p>
      <div class="calculation">本例有效牌十种，扣除手牌后共三十六枚</div>`,
    quizzes: [
      {
        prompt: "黏着一向听的核心缺口是什么？",
        choices: [
          ["还缺最后一个搭子",true,"三个面子和雀头已经齐备。"],
          ["还缺全部四个面子",false,"题型已经拥有三个完成面子。"],
          ["还缺固定的雀头对子",false,"题型定义中已有固定对子。"]
        ]
      },
      {
        prompt: `${rack(["1m","5m"],"一万与五万两张浮牌")}作为黏着形发动机，通常哪张连接更宽？`,
        choices: [
          ["五万连接范围更宽",true,"中张可以向两侧距离一或二连接。"],
          ["一万连接范围更宽",false,"幺九只能向牌面内侧延伸。"],
          ["两张连接范围相同",false,"边缘位置减少了一万的邻近牌。"]
        ]
      },
      {
        prompt: "两张浮牌的邻近有效牌重叠时，怎样计算？",
        choices: [
          ["取牌种并集后去重",true,"同一张牌不能在两个黏着范围中重复相加。"],
          ["两个范围直接全部相加",false,"重叠会造成虚增。"],
          ["把所有重叠牌判无效",false,"重叠牌仍然有效。"]
        ]
      }
    ],
    retrieval: "黏着形中，中张浮牌为什么从改良牌升级成直接有效牌？",
    source: commonSource
  },
  {
    slug: "0017-complex-waits",
    id: "lesson-0017",
    title: "复杂听牌：从牌图反推所有拆法",
    objective: "识别延单骑、三面听与烟囱形，避免只看到最显眼的一种和牌。",
    principle: "复杂听牌的答案，是所有合法“面子加雀头”拆法产生的等待牌并集。",
    concepts: [
      ["延单骑与三面听","连续四张可在两端留下单骑；连续五张可由多种双顺子拆法产生三面等待。"],
      ["烟囱形","顺子方向、刻子方向与对子方向重叠，等待牌常超过肉眼第一反应。"]
    ],
    exampleTitle: "三种高频复杂等待",
    exampleTiles: ["1p","2p","3p","4p","5p","6p","7s","8s","9s","3m","4m","5m","6m"],
    exampleLabel: "三个完成面子与三四五六万延单骑",
    exampleHtml: `${rack(["3m","6m"],"三四五六万延单骑等待三万与六万",{0:"effective",1:"effective"})}
      <p>三四五万成顺子可留下六万单骑；四五六万成顺子可留下三万单骑。</p>
      ${rack(["2s","3s","4s","5s","6s","1s","4s","7s"],"二三四五六索三面听等待一索四索七索",{5:"effective",6:"effective",7:"effective"})}
      <p>连续五张需要组成两个顺子时，等待来自左、中、右三种补法；手中已有的同种牌要从四张扣除。</p>
      ${rack(["2p","3p","3p","3p","1p","2p","4p"],"二三三三筒烟囱形等待一筒二筒四筒",{4:"effective",5:"effective",6:"effective"})}`,
    quizzes: [
      {
        prompt: `${rack(["3s","4s","5s","6s"],"三四五六索延单骑")}这组牌与三个完成面子组合时等待什么？`,
        choices: [
          ["等待三索以及六索",true,"可分别留下两端牌作单骑。"],
          ["只等待二索和七索",false,"那是把中间两张误当普通两面。"],
          ["只等待四索和五索",false,"中间牌不是延单骑的两端。"]
        ]
      },
      {
        prompt: `${rack(["2m","3m","4m","5m","6m"],"二三四五六万连续五张")}组成两个顺子时等待哪组？`,
        choices: [
          ["等待一万四万七万",true,"分别补成一二三、三四五或五六七方向。"],
          ["等待二万五万八万",false,"这些补牌不能对应三种双顺子拆法。"],
          ["只等待四万一种牌",false,"遗漏了左右两端的合法完成。"]
        ]
      },
      {
        prompt: "复杂听牌枚数为什么不能只用“种数乘四”？",
        choices: [
          ["手中已经占用同种牌",true,"复杂形往往自身含有等待牌，剩余副本少于四张。"],
          ["每种牌实际都有五张",false,"日麻每种牌仍只有四张。"],
          ["复杂形完全不计算枚数",false,"仍应逐种扣除已知牌。"]
        ]
      }
    ],
    retrieval: "复杂等待不靠眼熟；枚举每一种面子与雀头拆法，再取并集。",
    source: commonSource
  },
  {
    slug: "0018-mastery-protocol",
    id: "lesson-0018",
    title: "何切仙人的训练协议",
    objective: "把知识转成速度、稳定性与迁移能力，用可观察指标证明掌握。",
    principle: "正确率先达到九成，再压到五秒；速度绝不以跳过向听检查为代价。",
    concepts: [
      ["正确性门槛","连续一百手综合色训练正确率至少九成；错误必须能定位到漏向听、漏牌种、错枚数或错破平层。"],
      ["速度门槛","最近五十手中位作答时间不超过五秒，且最慢四分位仍能保持向听优先。"]
    ],
    exampleTitle: "每一错都要归因",
    exampleTiles: ["1m","2m","3m","4m","5m","6m","1p","2p","6p","7p","2s","4s","5z","5z"],
    exampleLabel: "六牌块综合色复盘手",
    exampleHtml: `<ol>
        <li><strong>若拆了完成面子：</strong>向听识别错误。</li>
        <li><strong>若拆了六七筒两面：</strong>直接枚数比较错误。</li>
        <li><strong>若在边张和嵌张间犹豫：</strong>主层已打平，应进入改良层。</li>
        <li><strong>若知道答案但超过十秒：</strong>模式检索尚未自动化，需要同构变体重复。</li>
      </ol>
      ${rack(["1p","2p","2s","4s"],"需要在边张与嵌张之间破平")}
      <div class="calculation">训练循环：限时作答 → 精确反馈 → 错误归因 → 间隔重测</div>`,
    quizzes: [
      {
        prompt: "正确率只有七成时，是否应该继续强压三秒？",
        choices: [
          ["先恢复慢算达到九成",true,"错误模式尚未稳定，强压速度只会自动化错误。"],
          ["继续提速忽略错误率",false,"流畅感不等于真实掌握。"],
          ["停止复盘只背最终答案",false,"没有原因反馈就无法迁移。"]
        ]
      },
      {
        prompt: "两手牌花色与数字不同，但牌块结构完全同构，训练价值是什么？",
        choices: [
          ["验证能否迁移结构规律",true,"真正掌握应跨花色与镜像保持判断。"],
          ["证明数字颜色决定答案",false,"同构结构的组合关系相同。"],
          ["减少所有需要的练习量",false,"仍需间隔与混合训练巩固。"]
        ]
      },
      {
        prompt: "达到课程毕业门槛后，下一步怎样保持能力？",
        choices: [
          ["用真实牌谱持续混合复盘",true,"真实上下文可暴露固定题库没有覆盖的干涉。"],
          ["永远不再计算有效牌数",false,"慢算仍是校准模式缓存的工具。"],
          ["把所有局面套同一口诀",false,"可见牌和复合结构会推翻默认排序。"]
        ]
      }
    ],
    retrieval: "毕业不是看完页面，而是用一百手正确率和五十手速度数据证明。",
    source: commonSource
  }
];
